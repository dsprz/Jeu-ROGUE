    ...
    def meet(self, other):
        ...
        if str(other.abbrv) == 'Metallica':
            ...
            for i in theGame().hero._stock:
                if isinstance(i, MetallicProjectile):
...
class Game(object):
    ...
    equipments = {0: [Food("Health pot", "Potion de vie",satiety = 20, usage=lambda self, creature: heal(creature)),
                      ...
                      Armor('Blue Armor', 'Blue Armor', usage = lambda self, creature : equipArmor(creature,10)) ], \
                  1: [
                      ...
                      Sword('Katana', 'Katana', attack = 15, usage =lambda self, creature : equip(creature,15)) ], \
                  2: [
